...
function Policies() {
    ...
    it('/policies', async function () {
        this.timeout(60000);
        let result;
        result = await axios.get(GetURL('policies'), {
            headers: {
        ...
        const schema = (
            await axios.get(GetURL('schemas'), {
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: `Bearer ${GetToken('RootAuthority')}`,
                },
    ...
    it('/policies/{policyId}', async function () {
        this.timeout(60000);
        let result;
        result = await axios.get(GetURL('policies', policyId), {
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${GetToken('RootAuthority')}`,
            },
        ...
        result = await axios.put(GetURL('policies', policyId), policy, {
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${GetToken('RootAuthority')}`,
            },
    ...
    it('/policies/validate', async function () {
        this.timeout(60000);
        let result;
        result = await axios.post(GetURL('policies', 'validate'), policy, {
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${GetToken('RootAuthority')}`,
            },
    ...
    it('/policies/{policyId}/blocks', async function () {
        this.timeout(60000);
        let result;
        result = await axios.get(GetURL('policies', policyId, 'blocks'), {
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${GetToken('RootAuthority')}`,
            },
    ...
    it('/policies/{policyId}/tag/{tag}', async function () {
        this.timeout(60000);
        let result;
        result = await axios.get(GetURL('policies', policyId, 'tag', 'Block2'), {
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${GetToken('RootAuthority')}`,
            },
    ...
    it('/policies/{policyId}/blocks/{uuid}', async function () {
        this.timeout(60000);
        let result;
        result = await axios.get(GetURL('policies', policyId, 'blocks', blockId), {
            headers: {
                'Content-Type': 'application/json',
    ...
    it('/policies/{policyId}/export/file', async function () {
        this.timeout(60000);
        let result;
        result = await axios.get(GetURL('policies', policyId, 'export', 'file'), {
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${GetToken('RootAuthority')}`,
            },
    ...
    it('/policies/import/file/preview', async function () {
        this.timeout(60000);
        let result;
        result = await axios.post(GetURL('policies', 'import', 'file', 'preview'), policyBlob, {
            headers: {
    ...
    it('/policies/import/file', async function () {
        ...
        result = await axios.post(GetURL('policies', 'import', 'file'), policyBlob, {
            headers: {
                'Content-Type': 'binary/octet-stream',
                Authorization: `Bearer ${GetToken('RootAuthority')}`,
            },
