...
function Profiles() {
    it('/profile/balance', async function () {
        this.timeout(60000);
        const result = await axios.get(GetURL('profile', 'balance'), {
            headers: {
    ...
    it('/profile', async function () {
        ...
        result = await axios.get(GetURL('profile'), {
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${GetToken('Installer')}`,
            },
        ...
        result = await axios.get(GetURL('demo', 'randomKey'), {
            headers: {
                'Content-Type': 'application/json',
            },
        });
        ...
        result = await axios.put(
            GetURL('profile'),
            {
                ...
                vcDocument: {
                    ...
                    '@context': ['https://ipfs.io/ipfs/bafkreibzihfnj67xgs74xfv2ap7rallevyce6uj5sg73j3p2cxlm2qx6ru'],
                },
                addressBook: {
