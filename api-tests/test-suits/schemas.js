...
function Schemas() {
    ...
    it('/schemas/balance', async function () {
        ...
        result = await axios.get(GetURL('schemas'), {
            headers: {
    ...
    it('/schemas/{schemaId}/export/message', async function () {
        let result;
        result = await axios.get(GetURL('schemas', schemaId, 'export', 'message'), {
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${GetToken('RootAuthority')}`,
            },
    ...
    it('/schemas/{schemaId}/export/file', async function () {
        let result;
        result = await axios.get(GetURL('schemas', schemaId, 'export', 'file'), {
            headers: {
                Authorization: `Bearer ${GetToken('RootAuthority')}`,
            },
    ...
    it('/schemas/import/file/preview', async function () {
        this.timeout(90000);
        let result;
        result = await axios.post(GetURL('schemas', 'import', 'file', 'preview'), schemaBlob, {
            headers: {
    ...
    it('/message/schemas/import/file', async function () {
        let result;
        result = await axios.post(GetURL('schemas', 'import', 'file'), schemaBlob, {
            headers: {
                'Content-Type': 'binary/octet-stream',
                Authorization: `Bearer ${GetToken('RootAuthority')}`,
            },
    ...
    it('/schemas/{schemaId}', async function () {
        let result;
        result = await axios.delete(GetURL('schemas', schemaId), {
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${GetToken('RootAuthority')}`,
            },
