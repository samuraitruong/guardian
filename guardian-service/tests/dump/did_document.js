            ...
            verificationMethod: [
                {
                    ...
                    controller:
                        'did:hedera:testnet:x719ZpApzxdFA23aUFsDLVjyNHPMeMcYpAcYBmW8nVn;hedera:testnet:fid=0.0.2859201',
                    publicKeyBase58: '7DE3CVyBywCSVbu6NqFouAPnEyP2PuiQMmN315rTKcxf',
                },
            ],
            authentication:
                'did:hedera:testnet:x719ZpApzxdFA23aUFsDLVjyNHPMeMcYpAcYBmW8nVn;hedera:testnet:fid=0.0.2859201#did-root-key',
            ...
            verificationMethod: [
                {
                    ...
                    type: 'Ed25519VerificationKey2018',
                    controller:
                        'did:hedera:testnet:DngCWN5hckWLRYnAijxQz5Q2Gyy6cxjnDgvq2VNbGMJj;hedera:testnet:fid=0.0.2276271',
                    publicKeyBase58: 'CoReRVJY82rMwPwnbm25yNGgdU4RviggYSUPFdUryD78',
                },
            ],
            authentication:
                'did:hedera:testnet:DngCWN5hckWLRYnAijxQz5Q2Gyy6cxjnDgvq2VNbGMJj;hedera:testnet:fid=0.0.2276271#did-root-key',
            assertionMethod: ['#did-root-key'],
        },
        status: 'CREATE',
        createDate: {
            ...
            verificationMethod: [
                {
                    ...
                    type: 'Ed25519VerificationKey2018',
                    controller:
                        'did:hedera:testnet:4iCPiUyiKcHaMLrytqRHavQRCknLGg4n3BcLc5unxn5K;hedera:testnet:fid=0.0.2859201',
                    publicKeyBase58: 'D2twjJruurR43XCyQEGNPWNjk4DcoqPyCpCfBVpSZ93d',
                },
            ],
            authentication:
                'did:hedera:testnet:4iCPiUyiKcHaMLrytqRHavQRCknLGg4n3BcLc5unxn5K;hedera:testnet:fid=0.0.2859201#did-root-key',
            assertionMethod: ['#did-root-key'],
        },
        status: 'CREATE',
        createDate: {
            ...
            verificationMethod: [
                {
                    ...
                    type: 'Ed25519VerificationKey2018',
                    controller:
                        'did:hedera:testnet:4AGt9SZtL2ybX9Hki9pqq3TgGSzy7BXh6XQLjPdinDku;hedera:testnet:fid=0.0.2276271',
                    publicKeyBase58: 'AN93B6m1UWoTUMmnHjiZugPR6fPgV4zF83w7zUDngnXE',
                },
            ],
            authentication:
                'did:hedera:testnet:4AGt9SZtL2ybX9Hki9pqq3TgGSzy7BXh6XQLjPdinDku;hedera:testnet:fid=0.0.2276271#did-root-key',
            assertionMethod: ['#did-root-key'],
        },
        status: 'CREATE',
        createDate: {
            ...
            verificationMethod: [
                {
                    ...
                    type: 'Ed25519VerificationKey2018',
                    controller:
                        'did:hedera:testnet:8NrYtVbU9opPNYZuEA4Zie4Bjy2wmBWn9eQY4YDmfSZ;hedera:testnet:fid=0.0.2859201',
                    publicKeyBase58: '9HfLrkUqt72cPxMaQgicnEu7AAoWP8YsRQ9sABGh7UWh',
                },
            ],
            authentication:
                'did:hedera:testnet:8NrYtVbU9opPNYZuEA4Zie4Bjy2wmBWn9eQY4YDmfSZ;hedera:testnet:fid=0.0.2859201#did-root-key',
            assertionMethod: ['#did-root-key'],
        },
        status: 'CREATE',
        createDate: {
