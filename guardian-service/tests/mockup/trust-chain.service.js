...
module.exports.testObject1 = [
        ...
        document: {
            ...
            verifiableCredential: [
                ...
                },
                {
                    ...
                    type: ['VerifiableCredential', 'MintToken'],
                    credentialSubject: [
                        {
                            '@context': ['https://localhost/schema'],
                            type: 'MintToken',
    ...
    },
    {
        ...
        document: {
            ...
            type: ['VerifiableCredential', 'Inverter'],
            credentialSubject: [
                {
                    '@context': ['https://localhost/schema'],
                    id: 'did:hedera:testnet:4iCPiUyiKcHaMLrytqRHavQRCknLGg4n3BcLc5unxn5K;hedera:testnet:fid=0.0.2859201',
    ...
    },
    {
        ...
        document: {
            ...
            type: ['VerifiableCredential', 'Installer'],
            credentialSubject: [
                {
                    '@context': ['https://localhost/schema'],
                    id: 'did:hedera:testnet:DngCWN5hckWLRYnAijxQz5Q2Gyy6cxjnDgvq2VNbGMJj;hedera:testnet:fid=0.0.2276271',
    ...
    },
    {
        ...
        document: {
            ...
            type: ['VerifiableCredential', 'RootAuthority'],
            credentialSubject: [
                {
                    '@context': ['https://localhost/schema'],
                    id: 'did:hedera:testnet:x719ZpApzxdFA23aUFsDLVjyNHPMeMcYpAcYBmW8nVn;hedera:testnet:fid=0.0.2859201',
        ...
        document: {
            ...
            verifiableCredential: [
                ...
                },
                {
                    ...
                    type: ['VerifiableCredential', 'MintNFToken'],
                    credentialSubject: [
                        {
                            '@context': ['https://localhost/schema'],
                            type: 'MintNFToken',
