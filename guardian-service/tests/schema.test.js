...
describe('Schema service', function () {
    ...
    const s1 = {
        ...
        document: JSON.stringify({
            ...
            $comment:
                '{"term": "0fae2a20-0db2-4835-bab9-99b4effbe03e", "@id": "#0fae2a20-0db2-4835-bab9-99b4effbe03e"}',
            title: '',
            description: '',
            type: 'object',
            properties: {
    ...
    const s2 = {
        ...
        document: JSON.stringify({
            ...
            $comment:
                '{"term": "59b934e2-9eb6-4395-9b85-ad3624f1f752", "@id": "#59b934e2-9eb6-4395-9b85-ad3624f1f752"}',
            title: '',
            description: '',
            type: 'object',
            properties: {
    ...
    const s3 = {
        ...
        document: JSON.stringify({
            ...
            $comment:
                '{"term": "ad2de08d-a43c-43c7-a458-3f0e8db65e8f", "@id": "#ad2de08d-a43c-43c7-a458-3f0e8db65e8f"}',
            title: '',
            description: '',
            type: 'object',
            properties: {
    ...
    before(async function () {
        ...
        service = schemaAPI(channel, schemaRepository);
    ...
    it('Test IMPORT_SCHEMES_BY_MESSAGES', async function () {
        ...
        value = await channel.run(IMPORT_SCHEMES_BY_MESSAGES, {
        ...
        value = await channel.run(IMPORT_SCHEMES_BY_MESSAGES, {
            messageIds: ['0fae2a20-0db2-4835-bab9-99b4effbe03e'],
            owner: 'owner',
        });
        checkMessage(value, [
            {
    ...
    it('Test PREVIEW_SCHEMA', async function () {
        ...
        value = await channel.run(PREVIEW_SCHEMA, {
            messageIds: ['0fae2a20-0db2-4835-bab9-99b4effbe03e'],
        });
