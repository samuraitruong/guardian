...
export class HederaSenderHelper {
     ...
     */
    public static async SubmitSchemaMessage(
        hederaSDKhelper: HederaSDKHelper,
        topicId: string,
        messageObject: ISchemaSubmitMessage
    ): Promise<string> {
     ...
     * @returns Message identifier
     */
    public static async SubmitPolicyMessage(
        hederaSDKhelper: HederaSDKHelper,
        topicId: string,
        messageObject: IPolicySubmitMessage
    ): Promise<string> {
        const message = JSON.stringify(messageObject);
        return await hederaSDKhelper.submitMessage(topicId, message);
    }
