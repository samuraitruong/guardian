...
export class VCJS {
     ...
     */
    public static async issue<T extends CredentialSubject>(
        vcDocument: HcsVcDocument<T>,
        suite: Ed25519Signature2018,
        documentLoader: DocumentLoaderFunction
    ): Promise<HcsVcDocument<T>> {
     ...
     */
    public static async issuePresentation(
        vpDocument: HcsVpDocument,
        suite: Ed25519Signature2018,
        documentLoader: DocumentLoaderFunction
